...
import project.tpi.oroa.bhie.Adult.InitialMenuAdultActivity;
...
public class InitialMenuActivity extends AppCompatActivity {
    ...
    public void onClickAdultSuperHero(View v)
    {
        try {
            Intent k = new Intent(InitialMenuActivity.this, InitialMenuAdultActivity.class);
            startActivity(k);
        } catch(Exception e) {
            e.printStackTrace();
        }
